...
export default function TeamsThree() {
  return (
    <>
      <div className="mx-auto max-w-7xl px-2 md:px-0">
        ...
        <div className="grid grid-cols-1 gap-[30px] md:grid-cols-3">
          ...
          <div className="flex flex-col items-center text-start">
            ...
            >
              <img
                src="https://s3-eu-west-1.amazonaws.com/blog.forestadmin.com/2021/09/FA-article-nodeJS@2x-1-.png"
                alt=""
                className="z-0 h-full w-full rounded-[10px] object-cover"
              />
              <div className="absolute bottom-4 left-4">
          ...
          <div className="flex flex-col items-center text-start">
            ...
            >
              <img
                src="https://markovate.com/wp-content/uploads/2022/06/Is-Express.js-Framework-An-Ideal-Choice-For-Developing-Enterprise-Applications_@2x.png.webp"
                alt=""
                className="z-0 h-full w-full rounded-[10px] object-cover"
              />
              <div className="absolute bottom-4 left-4">
          ...
          <div className="flex flex-col items-center text-start">
            ...
            >
              <img
                src="https://learn.microsoft.com/en-us/shows/mysql-developer-essentials-series/media/mysql-banner.png"
                alt=""
                className="z-0 h-full w-full rounded-[10px] object-cover"
              />
              <div className="absolute bottom-4 left-4">
